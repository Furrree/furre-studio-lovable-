              ...
              >
                ...
                <div className="flex gap-4 mb-8">
                  <Button
                    ...
                    onClick={() => window.open('https://www.octoboard.com/real-time-business-dashboard-live', '_blank')}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => window.open('https://github.com/furrealfread/pulse-analytics', '_blank')}
                  >
